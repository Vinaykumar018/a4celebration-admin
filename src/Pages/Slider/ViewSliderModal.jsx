...
const ViewSliderModal = ({ show, onClose, slider }) => {
  if (!show || !slider) return null;
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Slider Details</h5>
            <button type="button" className="btn-close" onClick={onClose}></button>
          </div>
          <div className="modal-body">
            <div className="row mb-3">
              <div className="col-md-4 fw-bold">Name:</div>
              <div className="col-md-8">{slider.name}</div>
            </div>
            <div className="row mb-3">
              <div className="col-md-4 fw-bold">Category:</div>
              <div className="col-md-8">{slider.category}</div>
            </div>
            <div className="row mb-3">
              <div className="col-md-4 fw-bold">Status:</div>
              <div className="col-md-8">
                <span className={`badge ${slider.status ? 'bg-success' : 'bg-danger'}`}>
