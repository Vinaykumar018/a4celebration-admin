...
const BhajanCategory = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await deleteBhajanCategory(categoryToDelete);
      if (response.status === 1) {
      ...
      <div className="card">
        <div className="card-header pb-2 pt-4 card-border">
          <div className='common-flex justify-between item-center'>
            <h5 className="mb-3">All Bhajan Categories</h5>
