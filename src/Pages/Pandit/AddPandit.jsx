...
const AddPandit = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to create pandit. Please try again.');
  ...
  return (
    <div className="card">
      <div className="card-header common-flex justify-between items-center">
        <h4 className="card-title">Add New Pandit</h4>
        ...
        >
          ...
          <div className="col-span-6 xl:col-span-6 sm:col-span-12">
            ...
            <input
              ...
              required
              minLength="8"
              autoComplete="new-password" // Prevent browser from suggesting passwords
            />
          ...
          <div className="col-span-6 xl:col-span-6 sm:col-span-12">
            ...
            <input
              ...
              onChange={handleInputChange}
              autoComplete="off" // Prevent autofill for sensitive data
            />
          </div>
