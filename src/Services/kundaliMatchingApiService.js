...
export const updateKundaliMatching = async (id, matchingData) => {
  try {
    const response = await axios.put(
      `${API_URL}/update-matching-details/${id}`,
      matchingData,
      getAuthHeader(),
    );
    return response.data;
...
export const deleteKundaliMatching = async (id) => {
  try {
    const response = await axios.delete(
      `${API_URL}/delete-matching-request/${id}`,
      getAuthHeader(),
    );
    return response.data;
  } catch (error) {
...
export const getKundaliMatchingsByUser = async (userId) => {
  try {
    const response = await axios.get(
      `${API_URL}/get-matching-user/${userId}`,
      getAuthHeader(),
    );
    return response.data;
  } catch (error) {
